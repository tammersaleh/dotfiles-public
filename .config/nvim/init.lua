...
vim.keymap.set({'n', 't'}, '<C-h>', function() vim.cmd.wincmd("h") end, {desc = "Move to window to the left."})
vim.keymap.set({'n', 't'}, '<C-j>', function() vim.cmd.wincmd("j") end, {desc = "Move to window below."})
vim.keymap.set({'n', 't'}, '<C-k>', function() vim.cmd.wincmd("k") end, {desc = "Move to window above."})
vim.keymap.set({'n', 't'}, '<C-l>', function() vim.cmd.wincmd("l") end, {desc = "Move to window to the right."})
